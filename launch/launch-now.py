"""
Direct pump.fun token creation using @solana-launchpad/sdk.
Bypasses PumpPortal — builds the transaction directly from the on-chain IDL.
"""
import subprocess
import sys
import os
...
# Write the Node.js launch script
js_script = Path(__file__).parent / "_create-token.mjs"
js_script.write_text(r"""
...
print(f"Running Node.js launch script...")
